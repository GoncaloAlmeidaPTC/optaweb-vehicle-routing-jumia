...
public class ChangeVehicleMaxWorkingHours implements ProblemFactChange<VehicleRoutingSolution> {

    private final PlanningVehicle vehicle;

    public ChangeVehicleMaxWorkingHours(PlanningVehicle vehicle) {
    ...
    public void doChange(ScoreDirector<VehicleRoutingSolution> scoreDirector) {
        ...
        workingVehicle.setMaxWorkingHours(vehicle.getMaxWorkingHours());
